	...
	<div align="center">
		...
		<form action="<%=ORSView.PATIENT_LIST_CTL%>" method="post">
			<%
				...
				List<PatientBean> deceaseList = (List<PatientBean>) request.getAttribute("deceaseList");
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>Name :</b></label> <input
						...
						<label><b>Decease : </b></label> <%=HTMLUtility.getList("decease", String.valueOf(bean.getDecease()), deceaseList)%>&emsp;
