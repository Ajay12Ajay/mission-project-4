...
public class CollegeModel {
	...
	public static Integer nextPk() throws DatabaseException {
		...
		try {
			...
			throw new DatabaseException("Exception: Exception in getting Pk in College");
	...
	public void add(CollegeBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			try {
				...
				e.printStackTrace();
				throw new ApplicationException("Exception : add rollback exception in college" + ex.getMessage());
			}
